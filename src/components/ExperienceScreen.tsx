    ...
    >
      ...
      <div className="flex items-start gap-3 mb-3">
        ...
        <div className="flex-1 min-w-0">
          <h3 className="text-sm font-bold text-white/95 leading-tight">{exp.title}</h3>
          <p className="text-xs font-semibold text-violet-400 mt-0.5">{exp.company}</p>
          <div className="flex items-center gap-3 mt-1.5">
            <div className="flex items-center gap-1">
              <MapPin size={9} className="text-white/30" />
              <span className="text-[10px] text-white/35">{exp.location}</span>
            </div>
            <div className="flex items-center gap-1">
              <Calendar size={9} className="text-white/30" />
              <span className="text-[10px] text-white/35">{exp.period}</span>
            </div>
          </div>
        </div>
      ...
      <button
        ...
        className="flex items-center gap-1.5 text-[11px] font-medium text-violet-400/80 hover:text-violet-400 transition-colors"
      >
    ...
    <div className="app-screen">
      <div className="screen-content space-y-4">
        ...
        >
          ...
          <p className="text-xs text-white/35 -mt-4 mb-2">Tap cards to expand details</p>
        </motion.div>
        ...
        >
          ...
          <span className="text-[11px] font-semibold text-emerald-400">2 Active Internships</span>
          <span className="text-[10px] text-white/30 ml-1">· NK SkillEdge & IT Daksh</span>
        </motion.div>
